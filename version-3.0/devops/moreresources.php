...
<html lang="en">
   <head>
      ...
      <meta name="description" content="Miracle is a Thought Leader is the space of Big Data, Advanced Analytics, BI/DWH, Database Management and Cognitive Science">
         ...
         <div class="col-sm-9">
            <div class="row">
               <div class="col-sm-12">
                   ...
                   <p class="methodText">Miracle is a Thought Leader is the space of Big Data, Advanced Analytics, BI/DWH, Database Management and Cognitive Science. Through our digital library we provide the world with use cases, solution architectures and more to help enable you to take the next step.</p>
               </div>
           <br>
...
<iframe src="https://player.vimeo.com/video/190865491" width="100%" height="380" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
                    ...
                    <div id="scroller" class="carousel slide" >
                        <div class="carousel-inner" >
                            <div class="item active" >
                                <div class="row">
                                    <div class="col-sm-4"><!--webinar--->
                                       ...
                                       <div class="embed-responsive embed-responsive-16by9">
                                        ...
                                        <a target="_blank"  href="http://www.miraclesoft.com/events/webinar-after.php?eventId=144">
                                            <img src="images/mulesoft.jpg" class="img-responsive" alt="Hybrid Integration">
                                            </a>

                                          </div>
                                        <a class="linkText1" target="_blank"  href="http://www.miraclesoft.com/events/webinar-after.php?eventId=144">
                                          <div class="container" style="background-color:#eee; margin-top:-5px;">
                        
                                                <p><center><strong>MuleSoft’s Anypoint Platform - Hybrid Integration </strong></center></p><br>
                                          </div>
                                       </a>
                                    ...
                                    <div class="col-sm-4"><!--webinar--->
                                        <div class="portfolio-item">
                                             ...
                                             <div class="card">
                                                  <div class="embed-responsive embed-responsive-16by9">
                                                <a target="_blank"  href="http://www.miraclesoft.com/library/video/understanding-continuous-integration-your-ibm-integration-bus-deployments">
                                            <img src="images/integration.jpg" class="img-responsive" alt="Integration">
                                            </a>
                                              

                                               </div>
                                               <a class="linkText1" target="_blank"  href="http://www.miraclesoft.com/library/video/understanding-continuous-integration-your-ibm-integration-bus-deployments">
                                                  <div class="container" style="background-color:#eee; margin-top:-5px;">
                                
                                                       <p><center><strong>Understanding Continuous Integration for your IBM Integration Bus Deployments</strong></center></p> 
                                                  </div>
                                               </a>
                                           </div>
                                           </div> 
                             ...
                             <a target="_blank"  href="http://www.miraclesoft.com/webinars/leverage-automated-testing-accelerate-digital-business-strategy">
                                            <img src="images/testing.jpg" class="img-responsive" alt="testing">
                                            </a>
                                                </div>
                                            <a class="linkText1" target="_blank"  href="http://www.miraclesoft.com/webinars/leverage-automated-testing-accelerate-digital-business-strategy">
                                                  <div class="container" style="background-color:#eee; margin-top:-5px;">
         ...
         <div class="col-sm-3 sidebar pull-right">
            ...
            <div class="list-group">
              ...
              <a href="index.php" class="list-group-item-1">
               ...
               <a href="mdashfor-iib.3.php" class="list-group-item">
                  <div>
    ...
    padding: 2px 16px;
         ...
         background-size: cover;
          height:120px;
                        ...
                        <center>
                           <a href="http://www.miraclesoft.com/library/CaseStudy/automated-scripting-data-load-fucntions.php">
                              <h3 class="heavy"></h3>
                              <p><font size="3px"color="#fff"><style="opacity:0!important;margin-top:-3px;"><strong>Automated Scripting and Data load Functions for Global Carpet Retailer</strong></style></font></p><br>
                           </a>
                        </center>
                     </div>
                  </div>
                  <div class="widget-content  text-dark register-hover">
                     <a class="linkText1" href="http://www.miraclesoft.com/library/CaseStudy/automated-scripting-data-load-fucntions.php" target="_blank">
              ...
              <span data-toggle="collapse">
                    <div class="widget">
                   <a href="mailto:sap@miraclesoft.com" > <div class="widget-content widget-hover themed-background text-light-op" style="margin-top:7px;">

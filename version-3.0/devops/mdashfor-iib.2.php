   ...
   <body>
      <section id="services" >
       ...
       <section id="services" class="container">
          ...
          <div class="row">
               ...
               <div class="col-sm-12">   
                ...
                <div class="row">
                       ...
                       <div class="col-sm-4">
                         <center><img class="img-reaponsive" src="images/Image11.png" alt="Image1" style="width:120px;height:120px"><center>
                         
                         <div class="">
                         
                          <h4 style="color:#232527;font-weight:bold">Higher	Visibility into	<br>Development	Cycle</h4>
                        </div>
                       </div>
                       ...
                       <div class="col-sm-4">
                         <center><img class="img-reaponsive" src="images/Image33.png" alt="Image3" style="width:120px;height:120px"><center>
                         
                         <div class="">
                         
                          <h4 style="color:#232527;font-weight:bold">Governance over Promote,<br>Rollback and Decommission</h4>
                        </div>
                       </div>
                        <div class="col-sm-4">
                         <center><img class="img-reaponsive" src="images/Image55.png" alt="Image2" style="width:120px;height:120px"><center>
                         
                         <div class="">
                         
                          <h4 style="color:#232527;font-weight:bold">Reduced Time for<br>Integration Results</h4>
                        </div>
                       </div>
         ...
         <div class="row">
               <div class="col-sm-12">     
                   <img class="img-responsive" src="images/DevOps22.png"></img>
               </div>
         </div>
            ...
            <div class="row" >
              <br>
              <div class="col-sm-4">
             <center> <img src="images/mean_150.png" class="img-responsive"></img></center>
           <center>  <h3 class="heavy">MEAN based	Tech Stack</h3></center>
             <center> <p class="greyText">Open	Source	and	Light	Weight	Implementation</p></center>
              
              </div>
              <div class="col-sm-4">
              <center><img src="images/Artifactory_150.png" class="img-responsive"> </img></center>
               <center><h3 class="heavy">Jenkins	and	Artifactory</h3></center>
               <center><p class="greyText">Open	Source Build Server	and Artifact Store for	mDash</p></center>
               
              
              </div>
              <div class="col-sm-4">
              <center><img src="images/IBM_150.png" class="img-responsive"></img></center>
              <center><h3 class="heavy">For IBM	Integration	Bus</h3></center>
    ...
    <div class="col-sm-12">   
    <br>
     <div style="background-image:url('images/cristus.jpeg');background-position:0px -155px; background-repeat:no-repeat; background-size:cover;">
                <div class="container" style="padding-left:3px; background-color: rgba(255,255,255,0.7) !important;" >
            <div class="col-sm-12 "><br>
               <p class="methodText">
             Check how our DevOps team provided a solution for our customer to improve quality leaks with maximum visibility into the build and deploy pipelines. We designed mDash for IIB, an application that orchestrates - build, test and deploy jobs while also managing rollbacks, decommissions and promotions by integrating with SVN, Jenkins, Artifactory and IIB Servers securely.

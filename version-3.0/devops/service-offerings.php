...
<html lang="en">
   <head>
      ...
      <meta name="description" content="We understand the need for continuous delivery within your organization – and we have helped our customers improve their teams through DevOps.">
...
tomorrow’s speed.</p>
             ...
             <div class="row">
         <div class="col-sm-12">
             <img src="images/DevOps.png" alt="DevOps" class="img-responsive">
             </div>
             </div>
                <!--<div class="row">
                <div class="col-sm-12">
                    <div class="col-sm-8">
                        <div class="row">
                           ...
                           <center><br> <img src="images/ValueDevOps.png" alt="image" class="img-responsive" height="100" width="100">
                            <h5 class="heavy">“Value of DevOps” Workshop</h5>
                        ...
                        <div class="col-sm-6">
                           <center> <br><img src="images/OrganizationAssessment.png" alt="image" class="img-responsive" height="100" width="100">
                            ...
                            <p>Analyze technology and state of your organization’s delivery</p></center>
                        </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6">

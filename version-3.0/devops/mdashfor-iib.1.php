      ...
      <section id="services" >
       ...
       <section id="services" class="container">
         ...
         <div class="col-sm-9">
             ...
             <h3 class="heavy">What	is	<font color="#ef4048"><strong>mDash</strong></font> for	<font color="#ef4048">IIB?</font></h3>
             
             
             <p class="methodText pull-left"><strong>Open	Source,	Self	Service	DevOps	Web	Portal</strong> for	managing	the	lifecycle	of	IBM	Integration	Bus	artifacts</p>
        ...
        <div class="row">
             <div class="col-sm-12">     
              <h3 class="heavy">Technology Scope</h3>     
                <p class="methodText">The products and technologies used in this effort by our team and the customer were, 
                  <div class="col-sm-12">
                   <ul class="col-sm-12">
                    <li>IBM Integration Bus with Healthcare Pack</li>
                    <li>SVN – Code Repository</li>
                    <li>Jenkins – Build Server</li>
                    <li>Artifactory – Build Artifact Store</li>
                    <li>CICD Tools – ANT and Junit</li>
                    <li>mDash – Node JS and Angular based Dashboard</li>
                   </ul>
                  </div>
                 </p>
              </div>
         ...
         <div class="row">
               <div class="col-sm-12">     
                 <h3 class="heavy">The Business Requirement</h3>     
                   <p class="methodText">
                     The customer’s current IIB environment had manual processes for BAR build, test, 
                     deploy and promote. This meant there was a larger scope for release delays and quality 
                     leaks with minimum visibility into the build and deploy pipelines.
                   </p>
                   <p class="methodText">
                     Not only were they looking for an automated solution, but also for a solution that was 
                     capable of providing enhanced visibility into their processes. 
                   </p>
               </div>
         </div>
          <div class="row">
               <div class="col-sm-12">     
                 <h3 class="heavy">Our Solution and Support</h3>     
                   <p class="methodText">
                     Miracle’s DevOps Team proposed mDash for IIB, a DevOps dashboard customized for 
                     IBM Integration Bus and based on Open Source technology. Through this dashboard 
                     the customer’s team would be able to build, deploy and test their work in various 
                     environments and also provide role-based promotion options. The dashboard and 
                     automation were delivered to the customer in a <span style="color:#ef4048;"><strong>Hybrid Delivery Model</strong></span>. 
                   </p>
                   <p class="methodText">The below were some of the major activities as part of the effort,
                     <div class="col-sm-12">
                      <ul class="col-sm-12">
                        <li><strong>DevOps Assesment and Roadmap Design</strong> – Analyzed the customer’s current development flow and designed an automation roadmap for IIB</li>
                        <li><strong>SVN Cleanup and Re-Design</strong> – Together with the customer’s team we redesigned their approach to SVN to ensure it was following best practices</li>
                        <li><strong>Install and Configure</strong> – Setup Jenkins and Artifactory and customize based on the customer’s environment and needs</li>
                        <li><strong>Build and Customize mDash</strong> – Customized mDash based on their requirements and existing framework around IIB; Deployed the dashboard</li>
                        <li><strong>Create Jenkins Jobs</strong> – Create the required Jenkins jobs including build, deploy, dependency check, rollback, decommission and more</li>
                      </ul>
                    </div>
                   </p>
               </div>
          ...
          <div class="row">
               <div class="col-sm-12">     
                   <img class="img-responsive" src="images/DevOps2.png"></img>
               </div>
         </div>
         <div class="row">
               <div class="col-sm-12">     
                 <h3 class="heavy">mDash Architecture</h3>     
                   <p class="methodText">
                     mDash for IIB was built on top of MEAN(Mongo DB, Express JS, Angular JS and
                     Node JS) using Open Source technologies such as Jenkins, Artifactory and SVN
                     behind the scenes. This meant that the customers could focus on their
                     development flow rather than the intricacies of Jenkins and other DevOps tools. 
                   </p>
               </div>
         </div><br>
         <div class="row">
               <div class="col-sm-12">     
                   <img class="img-responsive" src="images/DevOps1.png"></img>
               </div>
         </div>
         <div class="row">
               <div class="col-sm-12">     
                 <h3 class="heavy">Customer Benefits</h3>     
                   <p class="methodText">
                     We were able to deliver a unified development portal, mDash for IIB, which is an 
                     one-stop-shop for orchestrating build, test, and deploy jobs while also managing 
                     rollbacks, decommissions and promotions by integrating with SVN, Jenkins, 
                     Artifactory and IIB Servers securely.  
                   </p>
                   <p class="methodText">Through the implementation of mDash for IIB, the customer realized the following benefits, 
                     <div class="col-sm-12">
                      <ul class="col-sm-12">
                        <li>Completely automated solution for building, deploying, testing and promoting their IIB Interfaces</li>
                        <li>The number of releases increased to 3 per week from once a week release cycle</li>
                        <li>Continuous deployment up to pre-production environment along with automated testing </li>
                        <li>An intuitive dashboard that gives visibility into the IIB infrastructure and SDLC metrics previously not measured </li>
                        <li>Ability to drill down into who authorized each release and which flows are failing the most </li>
                        <li>Integration into their existing Active Directory setup meant that they could track who was doing what within their development teams</li>
                        <li>Automated Library and Dependency Management meant that they could track dependencies and fail-fast</li>
                      </ul>
                    </div>
                   </p>
               </div>
          <div class="row">
               <div class="col-sm-12">     
                   <h3 class="heavy">Advantages <span style="color:#232527;"><strong>of mDash for IIB</strong></span></h3>
               </div>
          </div>
    ...
    <div class="carousel-inner">
      ...
      <div class="item active">
         <div class="row">
                       ...
                       <div class="col-sm-4">
                         <center><img class="img-reaponsive" src="images/Image1.png" alt="Image1" style="width:120px;height:120px"><center>
                         
                         <div class="">
                         
                          <h4 style="color:#ef4048;font-weight:bold">Higher	Visibility into	<br>Development	Cycle</h4>
                        </div>
                       </div>
                       
                      <div class="col-sm-4">
                         <center><img class="img-reaponsive" src="images/Image2.png" alt="Image2" style="width:120px;height:120px"><center>
                         
                         <div class="">
                         
                          <h4 style="color:#ef4048;font-weight:bold">Automated Build,<br>Deploy	and	Test</h4>
                        </div>
                       </div>
                       
                       <div class="col-sm-4">
                         <center><img class="img-reaponsive" src="images/Image3.png" alt="Image3" style="width:120px;height:120px"><center>
                         
                         <div class="">
                         
                          <h4 style="color:#ef4048;font-weight:bold">Governance over Promote,<br>Rollback and Decommission</h4>
                        </div>
                       </div>
     ...
     <div class="row">
                       ...
                       <div class="col-sm-4">
                         <center><img class="img-reaponsive" src="images/Image4.png" alt="Image1" style="width:120px;height:120px"><center>
                         
                         <div class="">
                         
                          <h4 style="color:#ef4048;font-weight:bold">Self-Service<br> DevOps Portal</h4>
                        </div>
                       </div>
                       
                      <div class="col-sm-4">
                         <center><img class="img-reaponsive" src="images/Image5.png" alt="Image2" style="width:120px;height:120px"><center>
                         
                         <div class="">
                         
                          <h4 style="color:#ef4048;font-weight:bold">Reduced Time for<br>Integration Results</h4>
                        </div>
                       </div>
                       
                       <div class="col-sm-4">
                         <center><img class="img-reaponsive" src="images/Image6.png" alt="Image3" style="width:120px;height:120px"><center>
                         
                         <div class="">
                         
                          <h4 style="color:#ef4048;font-weight:bold">Open Source based<br> DevOps approach</h4>
                        </div>
                       </div>

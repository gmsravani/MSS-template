...
B2B/EDI	consultants	present	in	our	team.	
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                       <div class="col-sm-2">
                           <br>
                        <img src="../b2b/images/Riskfree.png" alt="Risk Free Transition" class="img-responsive">
                    </div>
                    <div class="col-sm-10">
...
methodology,	your	B2Bi/MFT	initiatives	are	in	safe	hands	
                ...
                <div style="margin-top:5px;" class="row">
                    <div class="col-sm-12">
                       <div class="col-sm-2">
                           <br>
                        <img src="../b2b/images/Knowledge.png" alt="Knowledge Management" class="img-responsive">
                    </div>
                    <div class="col-sm-10">
...
model	along	with	extensive	documentation	during	transition			
                ...
                <div style="margin-top:5px;" class="row">
                    <div class="col-sm-12">
                       <div class="col-sm-2">
                           <br>
                        <img src="../b2b/images/Leadership.png" alt="Thought	Leadership" class="img-responsive">
                    </div>
                    <div class="col-sm-10">
...
possible.	
          ...
          <div class="row">
            ...
            <div class="row">
               ...
               <div class="effect col-sm-4">
                  <div class="card">
  <a class="linkText1" target="_blank"  href="http://www.miraclesoft.com/why/sstory3.php"><img height="130px" src="../b2b/images/healthleader.jpg" alt="Global Healthcare" style="width:100%">
  <div class="container" style="background-color:#eee;">
    ...
    <p><center><strong>Migration from TPEC to WTX for Global Healthcare Leader</strong></center></p> 
                ...
                <div class="effect col-sm-4">
                    <div class="card">
  <a class="linkText1"  target="_blank" href="http://www.miraclesoft.com/why/sstory6.php"><img height="130px" src="../b2b/images/logistics.jpg" alt="Global Logistics" style="width:100%">
  <div class="container" style="background-color:#eee;">
     ...
     <p><center><strong>Next Generation ESB/B2B Gateway for Global Logistics Provider</strong></center></p> 
                 ...
                 <div class="effect col-sm-4">
                     <div class="card">
 <a class="linkText1" target="_blank" href="http://www.miraclesoft.com/why/sstory7.php"> <img height="130px" src="../b2b/images/food.png" alt="Global Food Distributor" style="width:100%">
  <div class="container" style="background-color:#eee;">
     ...
     <p><center><strong>Enhanced Visibility and Control for Global Food Distributor </strong></center></p> 
            ...
            <div class="row">
                <div class="col-sm-4">
                <img style="margin-top:27px;" src="../b2b/images/port.png" alt="logistics" class="img-responsive">
            </div>
            <div class="col-sm-8">
...
<a href="mscvp.php" target="_blank"> <button style="background-color:#00aae7 !important;" type="button" class="btn btn-primary btn-md">Read More</button></a>
            ...
            <div style="margin-left:-39px;" class="row">
                  <div class="col-sm-12">
		                   <div class="col-sm-2">
		                      <img src="../b2b/images/ibm.png" alt="ibm logo" class="img-responsive">
		                   </div>
		                   <div class="col-sm-2">
		                      <img src="../b2b/images/microsoft.png" alt="microsoft" class="img-responsive">
		                   </div>
		                   <div class="col-sm-2">
		                      <img src="../b2b/images/oracle.png" alt="oracle" class="img-responsive">
		                   </div>
		                    <div class="col-sm-2">
		                      <img src="../b2b/images/axway.png" alt="axway" class="img-responsive">
		                   </div>
		                   <div class="col-sm-2">
		                      <img src="../b2b/images/sap.png" alt="sap" class="img-responsive">
		                   </div>
		                   <div class="col-sm-2">
		                      <img src="../b2b/images/mulesoft.png" alt="mulesoft" class="img-responsive">
		                   </div>

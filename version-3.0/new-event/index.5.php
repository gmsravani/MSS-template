            ...
            <div class="container ">
               <div style="margin-bottom:-13px;" class="row">
                  ...
                  <div class="col-sm-6 text-left">
                     <h1 class="heavy micro">Gallery</h1>
                     <br>
                  </div>
...
<div class="container">
   <div class="row">
      <div class="col-sm-3 jm-item second">
	<div class="jm-item-wrapper">
		<div class="jm-item-image">
			<img src="images/q1meet-2017.png"/>
			<div class="jm-item-description">
			    May 4th, 2017
			    <div class="jm-item-button"><a target="_blank" href="../../gallery/q1meet-17.php">View</a></div>
			</div>
		</div>
		<div class="jm-item-title">Q#1 Meet 2017</div>
	</div>
</div>
<div class="col-sm-3 jm-item second">
	<div class="jm-item-wrapper">
		<div class="jm-item-image">
			<img src="images/apcloud-gallery.png"/>
			<div class="jm-item-description">
			   August 5th, 2016
			    <div class="jm-item-button"><a target="_blank" href="../../gallery/apcloud-gallery.php">View</a></div>
			</div>
		</div>
		<div class="jm-item-title">AP Cloud Initiative</div>
	</div>
</div>
<div class="col-sm-3 jm-item second">
	<div class="jm-item-wrapper">
		<div class="jm-item-image">
			<img src="images/aioug-vizag-2016.png" />
			<div class="jm-item-description">
			   June 18th, 2016
			    <div class="jm-item-button"><a target="_blank" href="../../gallery/aioug-2016.php">View</a></div>
			</div>
		</div>
		<div class="jm-item-title">Vizag Chapter - AIOUG - 2016</div>
	</div>
</div>
<div class="col-sm-3 jm-item second">
	<div class="jm-item-wrapper">
		<div class="jm-item-image">
			<img src="images/q1-gallery-2016.png" />
			<div class="jm-item-description">
			   April 2nd, 2016
			    <div class="jm-item-button"><a target="_blank" href="../../gallery/q1-meet-gallery-2016.php">View</a></div>
			</div>
		</div>
		<div class="jm-item-title">Q#1 Meet 2016</div>
	</div>
</div>
<div class="col-sm-3 jm-item second">
	<div class="jm-item-wrapper">
		<div class="jm-item-image">
			<img src="images/cubicle-contest-gallery.png" />
			<div class="jm-item-description">
			   February 16th, 2016
			    <div class="jm-item-button"><a target="_blank" href="../../gallery/cubicle-contest-gallery-2016.php">View</a></div>
			</div>
		</div>
		<div class="jm-item-title">Cubicle Contest-2016</div>
	</div>
</div>
<div class="col-sm-3 jm-item second">
	<div class="jm-item-wrapper">
		<div class="jm-item-image">
			<img src="images/republic-day-gallery.png" />
			<div class="jm-item-description">
			   January 26th, 2016
			    <div class="jm-item-button"><a target="_blank" href="../../gallery/republic-day-gallery-2016.php">View</a></div>
			</div>
		</div>
		<div class="jm-item-title">Republic Day-2016</div>
	</div>
</div>
<div class="col-sm-3 jm-item second">
	<div class="jm-item-wrapper">
		<div class="jm-item-image">
			<img src="images/pongal-gallery-index-2016.png" />
			<div class="jm-item-description">
			   January 15th, 2016
			    <div class="jm-item-button"><a target="_blank" href="../../gallery/pongal-2016.php">View</a></div>
			</div>
		</div>
		<div class="jm-item-title">Pongal Celebrations-2016</div>
	</div>
</div>
<div class="col-sm-3 jm-item second">
	<div class="jm-item-wrapper">
		<div class="jm-item-image">
			<img src="images/christmas-gallery-index.png" />
			<div class="jm-item-description">
			   December 25th, 2015
			    <div class="jm-item-button"><a target="_blank" href="../../gallery/christmas-gallery-2015.php">View</a></div>
			</div>
		</div>
		<div class="jm-item-title">Christmas-2015</div>
	</div>
</div>
<div class="col-sm-3 jm-item second">
	<div class="jm-item-wrapper">
		<div class="jm-item-image">
			<img src="images/beach-party-gallery-index.png" />
			<div class="jm-item-description">
			  December 19th, 2015
			    <div class="jm-item-button"><a target="_blank" href="../../gallery/beach-party.php">View</a></div>
			</div>
		</div>
		<div class="jm-item-title">Beach Party-2015</div>
	</div>
</div>
<div class="col-sm-3 jm-item second">
	<div class="jm-item-wrapper">
		<div class="jm-item-image">
			<img src="images/araku-gallery-index.png" />
			<div class="jm-item-description">
			  November 14-15th, 2015
			    <div class="jm-item-button"><a target="_blank" href="../../gallery/winterpicnic-gallery-2015.php">View</a></div>
			</div>
		</div>
		<div class="jm-item-title">Winter Picnic-2015</div>
	</div>
</div>
<div class="col-sm-3 jm-item second">
	<div class="jm-item-wrapper">
		<div class="jm-item-image">
			<img src="images/diwali-2015.png" />
			<div class="jm-item-description">
			  November 11th, 2015
			    <div class="jm-item-button"><a target="_blank" href="../../gallery/diwali-2015.php">View</a></div>
			</div>
		</div>
		<div class="jm-item-title">Diwali-2015</div>
	</div>
</div>
<div class="col-sm-3 jm-item second">
	<div class="jm-item-wrapper">
		<div class="jm-item-image">
			<img src="images/q2meet2015.png" />
			<div class="jm-item-description">
			  August 15th, 2015
			    <div class="jm-item-button"><a target="_blank" href="../../gallery/q2-meet-2015.php">View</a></div>
			</div>
		</div>
		<div class="jm-item-title">Quarterly Meet 2 </div>
	</div>
</div>
   </div>

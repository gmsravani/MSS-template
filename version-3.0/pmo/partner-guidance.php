               ...
               <div class="row">
                  ...
                  <div class="col-sm-6 text-right">
                     ...
                     <ul class="breadcrumb pull-right">
                        ...
                        <li class="active">Project Guidence</li>
                     </ul>
                  </div>
               </div>
            </div>
...
devoted	to	PPM.	
                  ...
                  <div class="row">
             <div class="col-sm-12">
               <img class="img-responsive" alt="ppmpracrice" src="images/ppm-pracrice.png"></img>
             </div>
          </div>
...
.container {
    padding: 2px 16px;
         ...
         <div class="row">
                <div class="col-sm-9">
            <p class="methodText"><em>For	 more	 information	 regarding <strong>Miracle’s	 Portfolio	 and	 Project	 Management	
Solutions</strong> reach	out	to <strong><a href="mailto:pmo@miraclesoft.com" class="linkText">pmo@miraclesoft.com.</a></strong></em></p>
</div>

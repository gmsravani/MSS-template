...
sourcing	model,		
              ...
              <div class="row">
                    ...
                    <div class="col-sm-12">
                       <div class="col-sm-2">
                          <br>
                        <img src="images/Onsite-1.png" alt="Onsite Resources" class="img-responsive">
                    </div>
                    <div class="col-sm-10">
...
own	resources!	
                ...
                <div style="margin-top:5px;" class="row">
                    <div class="col-sm-12">
                       <div class="col-sm-2">
                          <br>
                        <img src="images/Offshore-1.png" alt="Offshore Resources" class="img-responsive">
                    </div>
                    <div class="col-sm-10">
...
achieved	using	this	model.				
                ...
                <div style="margin-top:5px;" class="row">
                    <div class="col-sm-12">
                       <div class="col-sm-2">
                          <br>
                        <img src="images/hybrid.png" alt="Hybrid Resources" class="img-responsive">
                    </div>
                    <div class="col-sm-10">

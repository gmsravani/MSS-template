      ...
      <section id="services" class="container">
         ...
         <div class="col-sm-9">
            <div class="row">
               <div class="col-sm-12">
                   <br>
                   <p class="methodText">Miracle is a Though Leader is the space of Big Data, Advanced Analytics, BI/DWH, Database Management and Cognitive Science. Through our digital library we provide the world with use cases, solution architectures and more to help enable you to take the next step.</p>
               </div>
           <br>
...
<iframe src="https://player.vimeo.com/video/200216281" width="100%" height="380" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
 ...
 <a target="_blank"  href="http://www.miraclesoft.com/events/webinar-after.php?eventId=151">
<img src="images/eCommerce-Platform.png" class="img-responsive" alt="eCommerce Platform">
</a>
                                       </div>
                                        <a class="linkText1" target="_blank"  href="http://www.miraclesoft.com/events/webinar-after.php?eventId=151">
   ...
   <a target="_blank" href="http://www.miraclesoft.com/events/webinar-after.php?eventId=213">                                           <!-- <iframe src="https://player.vimeo.com/video/176598772" width="100%" height="auto" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>-->
<img src="images/sentiment-analytics.png" class="img-responsive" alt="Sentiment Analytics">
</a>
                                               </div>
                                               <a class="linkText1" target="_blank"  href="http://www.miraclesoft.com/events/webinar-after.php?eventId=213">
                                                  <div class="container" style="background-color:#eee; margin-top:-5px;">
...
<a target="_blank"  href="http://www.miraclesoft.com/events/webinar-after.php?eventId=205">
<img src="images/building-microservices.png" class="img-responsive" alt="Building Microservices">
</a>
                                                </div>
                                            <a class="linkText1" target="_blank"  href="http://www.miraclesoft.com/events/webinar-after.php?eventId=205">
                                                  <div class="container" style="background-color:#eee; margin-top:-5px;">
                                
                                                       <p><center><strong>Building Microservices with the Mulesoft Anypoint Platform </strong></center></p> 
                                                  </div>
                                               </a>
                                     ...
                                     <div class="col-sm-4"><!--webinar--->
                                        <div class="portfolio-item">
                                             ...
                                             <!--  <iframe src="https://player.vimeo.com/video/171746746" width="100%" height="auto" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>--->
                                                <a target="_blank"  href="http://www.miraclesoft.com/events/webinar-after.php?eventId=207">
                                               <img src="images/multi-cloud.png" class="img-responsive" alt="Multi-Cloud">
                                               </a>
                                                </div>
                                               <a class="linkText1" target="_blank"  href="http://www.miraclesoft.com/events/webinar-after.php?eventId=207">
                                                  <div class="container" style="background-color:#eee; margin-top:-5px;">
 ...
 <a target="_blank"  href="http://www.miraclesoft.com/events/webinar-after.php?eventId=178">
<img src="images/watson-developer.png" class="img-responsive" alt="Watson Developer">
</a>
                                               </div>
                                               <a class="linkText1" target="_blank"  href="http://www.miraclesoft.com/events/webinar-after.php?eventId=178">
                                                  <div class="container" style="background-color:#eee; margin-top:-5px;">
                                        ...
                                        <div class="portfolio-item">
                                             ...
                                             <div class="card">
                                              ...
                                              <!-- <iframe src="https://player.vimeo.com/video/165608037" width="100%" height="auto" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>--->
                                               <a target="_blank"  href="http://www.miraclesoft.com/events/webinar-after.php?eventId=177">
                                               <img src="images/integration-and-testing.png" class="img-responsive" alt="Integration-and-Testing">
                                               </a>
                                                </div>
                                               <a class="linkText1" target="_blank"  href="http://www.miraclesoft.com/events/webinar-after.php?eventId=177">
                                                  <div class="container" style="background-color:#eee; margin-top:-5px;">
                                     ...
                                     <div class="col-sm-4"><!--webinar--->
                                        <div class="portfolio-item">
                                             ...
                                             <div class="card">
                                                 ...
                                                 <!-- <a class="linkText1" target="_blank"  href="http://www.miraclesoft.com/events/webinar-after.php?eventId=123"><img src="images/infosphere.png" alt="InfoSpehere" class="img-responsive"></a>-->
                                             <!--  <iframe src="https://player.vimeo.com/video/171746746" width="100%" height="auto" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>--->
                                                <a target="_blank"  href="https://www.miraclesoft.com/library/video/miracle-framework-microsoft-azure-power-bi.php">
                                               <img src="images/microsoft-azure.png" class="img-responsive" alt="Multi-Cloud">
                                               </a>
                                                </div>
                                               <a class="linkText1" target="_blank"  href="https://www.miraclesoft.com/library/video/miracle-framework-microsoft-azure-power-bi.php">
                                                  <div class="container" style="background-color:#eee; margin-top:-5px;">
                                
                                                       <p><center><strong>Introduction to Microsoft Azure Power BI <br></strong></center></p> 
                                                  </div>
                                               </a>
...
.container {
    padding: 2px 16px;
                        ...
                        <center>
                           <a href="http://www.miraclesoft.com/library/CaseStudy/nextgen-integration-platform-electronics-retailer.php">
                              <h3 class="heavy"></h3>
                  ...
                  <div class="widget-content  text-dark register-hover">
                     <a class="linkText1" href="http://www.miraclesoft.com/library/CaseStudy/nextgen-integration-platform-electronics-retailer.php" target="_blank">
         ...
         <div class="row">
            ...
            <p class="methodText">
             <i>  For more information regarding <strong>Miracle’s Big Data and Analytics Offerings	</strong> reach out to <strong><a href="mailto:data@miraclesoft.com" class="linkText">data@miraclesoft.com</a></strong></i>
            </p></div>

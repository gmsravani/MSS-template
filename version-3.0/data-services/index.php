...
help	you	deliver	the	right	solutions	at	the	right	time.		
        ...
        <div class="col-sm-4">
                  ...
                  <div class="container" style="background-color:#eee;">
                   <center>
                         <ul style="text-align:left; padding: 12px 33px 33px 26px;" class="bigdata">
               ...
               <div class="col-sm-4">
                  ...
                  <div class="container" style="background-color:#eee;">
                   <center>
                           <ul class="buissness" style="text-align:left;  padding: 12px 33px 33px 21px;">
              
                                  <li>Statistical Analysis</li> 
                                  <li>Quantitative Analysis</li>
                                  <li> Data Mining</li>
                                  <li> Predictive Modeling</li>
                                 <li>Data Science experience utilizing R, Python, IBM Watson, and Cortana Alteryx/RapidMiner</li>
                                 <li>H2O</li>
                                 <li>Apache Spark</li>
                 ...
                 <div class="col-sm-4">
                  ...
                  <div class="container" style="background-color:#eee;">
                   <center>
                          <ul style="text-align:left; padding: 12px 33px 33px 21px;" class="busint">
...
<div class="row" >
        <div class="col-sm-12">
           ...
           <br>
                     ...
                     <div class="col-sm-2">
                        <br><br><img src="images/separation-vertical.png" class="img-responsive sep">
                     </div>
                     <div class="col-sm-5"><ul class="sep1"><br>
                            <li>Cassandra</li>
                                 <li>DB2</li>
          ...
          <div class="row">
            ...
            <div class="row">
               ...
               <div class="effect col-sm-4">
                  <div class="card">
  <a class="linkText1" target="_blank"  href="http://www.miraclesoft.com/why/sstory3.php"><img height="130px" src="images/healthleader.jpg" alt="Avatar" style="width:100%">
  <div class="container" style="background-color:#eee;">
    ...
    <p><center><strong>Migration from TPEC to WTX for Global Healthcare <br>Leader <br><br></strong></center></p> 
                ...
                <div class="effect col-sm-4">
                  <div class="card">
  <a class="linkText1" target="_blank"  href="http://www.miraclesoft.com/why/sstory6.php"><img height="130px" src="images/logistics.jpg" alt="Avatar" style="width:100%">
  <div class="container" style="background-color:#eee;">
    ...
    <p><center><strong>Next Generation ESB/B2B Gateway for Global Logistics Provider <br><br></strong></center></p> 
                 ...
                 <div class="effect col-sm-4">
                     <div class="card">
 <a class="linkText1" target="_blank" href="http://www.miraclesoft.com/why/sstory7.php"> <img height="130px" src="images/food.png" alt="Avatar" style="width:100%">
  <div class="container" style="background-color:#eee;">
     ...
     <p><center><strong>Enhanced Visibility and Control for Global Food Distributor <br><br></strong></center></p> 
            ...
            <div style="margin-left:-39px;" class="row">
                  <div class="col-sm-12">
		                   <div class="col-sm-2">
		                      <img src="images/ibm.png" alt="IBM logo" class="img-responsive ibm3">
		                   </div>
		                   <div class="col-sm-2">
		                      <img src="images/microsoft.png" alt="Microsoft logo" class="img-responsive micro3">
		                   </div>
		                   <div class="col-sm-2">
		                      <img src="images/infa_authreseller_vert_black.png" alt="Informatica logo" class="img-responsive vert">
		                   </div>
		                   <div class="col-sm-2">
		                      <img src="images/cloudera_connect_logo.png" alt="Cloudera logo" class="img-responsive info1 cont">
		                   </div>
		                    
		                   <div class="col-sm-2">
		                      <img src="images/sap-silver-partner.png" alt="SAP logo" class="img-responsive partner">
		                   </div>
		                   <div class="col-sm-2">
		                   </div>
...
.container {
    padding: 2px 16px;
                        ...
                        <center>
                           <a href="http://www.miraclesoft.com/library/CaseStudy/mft-changes-using-ibm-sterling-graphic-process-manager.php">
                              <h3 class="heavy"></h3>
                  ...
                  <div class="widget-content  text-dark register-hover">
                     <a class="linkText1" href="http://www.miraclesoft.com/library/CaseStudy/mft-changes-using-ibm-sterling-graphic-process-manager.php" target="_blank">

   ...
   <body>
      ...
      <section id="services" class="container">
            ...
            <div class="row">
               <div class="col-sm-12">  <br>
                  ...
                  <div class="row">
                      ...
                      <li>Data Extraction Services(ETL)</li>
                      <li>Data Quality Services</li>
                      </ul>
                      </div>
                      <div class="col-sm-4">
                      <ul>
                      <li>Master Data Management Services</li>
        ...
        <div class="col-sm-12">
           ...
           <div class="row">
                  <div class="col-sm-12">
                      <h1 class="heavy">Miracle's BigData/DW/BI/BW Overview</h1>
                   </div>
          </div> 
             <div class="row" >
                 <div class="col-sm-6">
...
<div class="row" >
           ...
           <br>
                 ...
                 <div class="col-sm-6">
                  <div class="card" id="check3">
                      <h3 class="heavy"style="margin:10px;padding-left:13px;"><font color="#ffffff" >Business Analytics</font></h3>
                 
                  <div class="container" style="background-color:#eee; height:255px;padding:2px;">
                    <center>
                           <ul style="text-align:left;">
              <br>
              <li>Statistical Analysis predictive modeling</li>
              <li>Quantitative analysis</li>
              <li>Data mining</li>
              <li> predictive modelling</li>
                                 <li>Data Science experience utilizing IBM Watson</li>
                                 <li>R and Python</li>
                                 <li>Apache Spark</li>
      ...
      <div class="row">
               <div class="col-sm-12">
                 ...
                 <div class="col-sm-4">
                  ...
                  <div class="widget box">
                     <div class="widget-content ibm greyht" style="border: 1px solid #eee;background-color:#eee; padding-bottom:93px;padding-top:20px;">
                              <ul>
                                <li>IBM DB2</li>
                                <li>Oracle</li>
                                <li>Teradata</li>
              ...
              <div class="col-sm-4">
                  ...
                  <div class="widget box">
                     <div class="widget-content ibm greyht2" style="border: 1px solid #eee; background-color:#eee;padding-bottom:73px;padding-top:20px;">
                          <ul>
                                <li>IBM Cognos</li>
                ...
                <div class="col-sm-4">
                  ...
                  <div class="widget box">
                     <div class="widget-content ibm greyht3" style="border: 1px solid #eee;background-color:#eee; padding-bottom:93px;padding-top:20px;">
                              <ul>
                                <li>Cloudera</li>
                                <li>HortonWorks</li>
                                <li>Map R</li>
...
.container {
    padding: 2px 16px;
                        ...
                        <center>
                           <a href="#">
                              <h3 class="heavy"></h3>
                              <p><font size="3px"color="#ffffff"><style="opacity:0!important;"><strong>Reduced spin-up time for agile MFT Changes using IBM Sterling Graphic Process Manager  </strong></style></font></p>
                           </a>
                        </center>
                     </div>
                  </div>

                                ...
                                <div class="row">
                                    <div class="col-sm-4"><!--webinar--->
                                       ...
                                       <div class="embed-responsive embed-responsive-16by9">
                                           <a class="linkText1" target="_blank"  href="https://www.miraclesoft.com/events/webinar-after.php?eventId=147"><img src="images/neoload.png" alt="QA" class="img-responsive"></a>
                                        ...
                                        <a class="linkText1" target="_blank"  href="https://www.miraclesoft.com/events/webinar-after.php?eventId=147">
                                          <div class="container" style="background-color:#eee; margin-top:-5px;">
                                                ...
                                                <p><center><strong> Exploring QA with Microsoft Test Manager and Team Foundation Server</strong></center></p>
                                          </div>
                                       </a>
                                    ...
                                    <div class="col-sm-4"><!--case study--->
                                        <div class="portfolio-item">
                                               ...
                                               <div class="effect ">
                                              <div class="card">
                                                <a class="linkText1" target="_blank"  href="http://www.miraclesoft.com/library/CaseStudy/automation-testing-web-services-large-retailer.php"><img  src="images/bhelk.png" alt="Automation Testing" class="img-responsive">
                                                  <div class="container" style="background-color:#eee;">
                                
                                                   <p><center><strong>Automation Testing for Web Services at Large Retailer</strong></center></p> <br>
                                                 </div>
                                                 </a>
                                              </div>
                                           </div>
                                    ...
                                    <div class="col-sm-4"><!--webinar--->
                                        <div class="portfolio-item">
                                             ...
                                             <div class="card">
                                                  <div class="embed-responsive embed-responsive-16by9">
                                                  <a class="linkText1" target="_blank"  href="https://www.miraclesoft.com/events/webinar-after.php?eventId=109"><img src="images/qa.png" alt="NeoLoad" class="img-responsive"></a>
                                               <a class="linkText1" target="_blank"  href="https://www.miraclesoft.com/events/webinar-after.php?eventId=109">
                                                  <div class="container" style="background-color:#eee; margin-top:-5px;">
                                
                                                       <p><center><strong>Exploring NeoLoad for Enterprise Performance Testing</strong></center></p> 
                                                  </div>
                                               </a>
                                           </div>
                                           </div>
                                ...
                                <div class="row">
                                     <div class="col-sm-4"><!--case study--->
                                        <div class="portfolio-item">
                                                  ...
                                                  <div class="effect ">
                                              <div class="card">
                                               <a class="linkText1" target="_blank"  href="http://www.miraclesoft.com/library/CaseStudy/testing-coe-global-carpet-manufacturer.php"><img  src="images/interface.png" alt="Testing COE" class="img-responsive">
                                                  <div class="container" style="background-color:#eee;">
                                
                                                        <p><center><strong>Establishing Testing COE for Global Carpet Manufacturer</strong></center></p> <br>
                                                  </div>
                                               </a>
                                           </div>
                                           </div>
                                    ...
                                    <div class="col-sm-4"><!--webinar--->
                                        <div class="portfolio-item">
                                                 ...
                                                 <div class="card">
                                                 <div class="embed-responsive embed-responsive-16by9"> 
                                                  <a class="linkText1" target="_blank"  href="https://www.miraclesoft.com/events/webinar-after.php?eventId=92"><img src="images/soasta.png" alt="Soasta CloudTest" class="img-responsive"></a>
                                               <a class="linkText1" target="_blank"  href="https://www.miraclesoft.com/events/webinar-after.php?eventId=92">
                                                  <div class="container" style="background-color:#eee; margin-top:-5px;">
                                
                                                        <p><center><strong>Performance Testing for the Cloud using SOASTA CloudTest</strong></center></p> 
                                                  </div>
                                               </a>
                                           </div>
                                           </div>
                                     ...
                                     <div class="col-sm-4"><!--case study--->
                                        <div class="portfolio-item">
                                              ...
                                              <div class="effect ">
                                              <div class="card">
                                                  <a class="linkText1" target="_blank"  href="http://www.miraclesoft.com/library/CaseStudy/erp-testing-services-major-construction-materials-customer.php"><img src="images/bmc.png" alt="ERP Testing Services" class="img-responsive">
                                               <div class="container" style="background-color:#eee;">
                                ...
                                <div class="row">
                                       <div class="col-sm-4"><!--webinar--->
                                        <div class="portfolio-item">
                                                 ...
                                                 <div class="card">
                                                 <div class="embed-responsive embed-responsive-16by9"> 
                                                   <a class="linkText1" target="_blank"  href="http://www.miraclesoft.com/events/webinar-after.php?eventId=85"><img src="images/jmeter.png" alt="JMeter" class="img-responsive"></a>
                                               <a class="linkText1" target="_blank"  href="http://www.miraclesoft.com/events/webinar-after.php?eventId=85">
                                                  <div class="container" style="background-color:#eee; margin-top:-5px;">
                                
                                                        <p><center><strong>Understanding JMeter and Performance Testing for your Organization</strong></center></p>
                                                  </div>
                                               </a>
                                           </div>
                                           </div>
                                     ...
                                     <div class="col-sm-4"><!--case study--->
                                        <div class="portfolio-item">
                                              ...
                                              <div class="effect ">
                                              <div class="card">
                                                  <a class="linkText1" target="_blank"  href="http://www.miraclesoft.com/library/CaseStudy/end-to-end-manual-testing-global-financial-holdings-enterprise.php"><img  src="images/atlanticus-financial.png" alt="Global Financial Holdings" class="img-responsive">
                                               <div class="container" style="background-color:#eee;">
                                
                                             <p><center><strong>End-to-End Manual Testing for Global Financial Holdings Enterprise</strong></center></p> 
                                            </div>
                                              </a>
                                            </div>
                                           </div>
                                     ...
                                     <div class="col-sm-4"><!--webinar--->
                                        <div class="portfolio-item">
                                                 ...
                                                 <div class="card">
                                                 <div class="embed-responsive embed-responsive-16by9">  
                                                 <a class="linkText1" target="_blank"  href="http://www.miraclesoft.com/events/webinar-after.php?eventId=27"><img src="images/leverage.png" alt="Digital Business Strategy" class="img-responsive"></a>

                                               <a class="linkText1" target="_blank"  href="http://www.miraclesoft.com/events/webinar-after.php?eventId=27">
                                                  <div class="container" style="background-color:#eee; margin-top:-5px;">
                                
                                                        <p><center><strong>Leverage Automated Testing to accelerate your Digital Business Strategy </strong></center></p>
                                                  </div>
                                               </a>
                                           </div>
                                           </div>
                                ...
                                <div class="row">
                                     <div class="col-sm-4"><!--case study--->
                                        <div class="portfolio-item">
                                              ...
                                              <div class="effect ">
                                              <div class="card">
                                                  <a class="linkText1" target="_blank"  href="http://www.miraclesoft.com/library/CaseStudy/manual-automation-testing-leading-beverages-customer.php"><img src="images/coke.png" alt="Leading Beverages" class="img-responsive">
                                               <div class="container" style="background-color:#eee;">
         ...
         url("images/bhelk.png"); 
                        ...
                        <center>
                           <a href="http://www.miraclesoft.com/library/CaseStudy/automation-testing-web-services-large-retailer.php">
                              <h3 class="heavy"></h3>
                              <p><font size="3px"color="#fff"><strong>Automation Testing for Web Services at Large Retailer</strong></style></font></p>
                           </a>
                        </center>
                     </div>
                  </div>

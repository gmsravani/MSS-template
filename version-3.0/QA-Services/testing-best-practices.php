...
<html lang="en">
         ...
         <div class="col-sm-9">
           ...
           <div class="row">
               ...
               <div class="effect col-sm-4">
                  <div class="card">
  <a class="linkText1" target="_blank" href="http://www.miraclesoft.com/library/CaseStudy/digital-integration-architecture-national-retailer"><img height="130px" src="images/fashion.png" alt="Avatar" style="width:100%">
  <div class="container" style="background-color:#eee;">
    ...
    <p><center><strong>Digital Integration Architecture for Major National Retailer</strong></center></p> 
                ...
                <div class="effect col-sm-4">
                    <div class="card">
  <a class="linkText1" target="_blank" href="http://www.miraclesoft.com/library/CaseStudy/edge-integration-and-digital-platform-for-pharmacy-retailer"><img height="130px" src="images/drug.png" alt="Avatar" style="width:100%">
  <div class="container" style="background-color:#eee;">
     ...
     <p><center><strong>EDGE Integration and Digital Platform for Pharmacy Retailer</strong></center></p> 
                 ...
                 <div class="effect col-sm-4">
                     <div class="card">
 <a class="linkText1" target="_blank" href="http://www.miraclesoft.com/library/CaseStudy/enterprice-reference-architecture-coe-for-healthcare-customer"> <img height="130px" src="images/health.png" alt="Avatar" style="width:100%">
  <div class="container" style="background-color:#eee;">

...
<html lang="en">
   ...
   <body>
            ...
            <div class="container ">
               <div style="margin-bottom:-13px;" class="row">
                  ...
                  <div class="col-sm-6 text-left">
                     <h1 class="heavy micro">Company</h1>
                  </div>
                  <br>
     ...
     <div class="row">
                ...
                <center><img alt="Thought Leadership" title="Thought Leadership" class="img-responsive" src="http://d2b8lqy494c4mo.cloudfront.net/mss/images/principles/principles1.png"><br>
                        ...
                        <div class="col-sm-4 center">
            <center><img alt="Global Delivery" title="Global Delivery" class="img-responsive" src="http://d2b8lqy494c4mo.cloudfront.net/mss/images/principles/principles4.png"><br>
                </center>                <div class="row center">
                                <div class="col-sm-1"></div>
                                <div class="col-sm-10">
                                    <h3 class="heavy">
                        ...
                        <div class="col-sm-4 center">
                <center><img alt="Industry Expertise" title="Industry Expertise" class="img-responsive" src="http://d2b8lqy494c4mo.cloudfront.net/mss/images/principles/principles3.png"><br>
                     </center>       <div class="row center">
                                <div class="col-sm-1"></div>
                                <div class="col-sm-10">
                                   <h3 class="heavy">
         ...
         <div class="col-sm-3 sidebar pull-right">
            ...
            <div class="list-group">
               ...
               <a href="partnerships.php" class="list-group-item">
                  <div>
                     <center><strong><font size="3%!important" color="#000">&nbsp; Partnerships
                        </font></strong>
                     </center>
                  </div>
               </a>
               
               <a href="vision2020.php" class="list-group-item">
                  <div>
                     <center>
                     <strong><font size="3%!important" color="#000">&nbsp; Vision 2020
                     </font></strong>
                     <center>
                  </div>
               </a>
               ...
               <br>
                <div >
                  <div class="widget-content themed-background text-light-op" style="background-color:#00aae7;height:62px;">
                     <center style="padding-top:5px;"><strong><font style="color:#ffffff;">Digital Library</font></strong></center>
                  </div>
...
.container {
    padding: 2px 16px;
                        ...
                        <center>
                           <a href="#">
                              <h3 class="heavy"></h3>
                              <p><font size="3px"color="#ffffff"><style="opacity:0!important;"><strong>Check our Technical articles, Case studies, On-Demand Webinars</strong></style></p>
                           </a>
                        </center>
                     </div>
                  </div>
                  ...
                  <div class="widget-content  text-dark register-hover">
                     <a class="linkText1" href="http://www.miraclesoft.com/library" target="_blank">
                        <center  style="padding-top:1px;"><strong><font style="color:#ffffff;" onMouseOut="this.style.color='#ffffff'" onMouseOver="this.style.color='#b7b2b3'">Explore now</font></strong></center>
                     </a>
                  </div>

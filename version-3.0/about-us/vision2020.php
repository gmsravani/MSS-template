   ...
   <body>
            ...
            <div class="container ">
               <div style="margin-bottom:-13px;" class="row">
                  ...
                  <div class="col-sm-6 text-left">
                     <h1 class="heavy micro">Vision 2020</h1>
                  </div>
                  <br>
                  <div class="col-sm-6 text-right" style="margin-top:-20px;">
                     <ul class="breadcrumb pull-right">
                        <li><a href="../">Home</a></li>
                        <li><a href="../technologies/">About Us</a></li>
                        <li class="active">Vision2020</li>
                     </ul>
                  </div>
               </div>
              <br><br>
      ...
      <section id="services" class="container">
        ...
        <div class="col-sm-3 center">
          ...
          <center>
            <img src="http://d2b8lqy494c4mo.cloudfront.net/mss/images/why/certified-professionals.png" class="img-responsive" alt="Customer-Success" title="Customer Success">
          </center>
          ...
          <div class="row">
            ...
            <div class="col-sm-12">
              ...
              <center>
                ...
                <p>
                  Help Transform and Optimize Your Business
                </p>
              </center>
        ...
        <div class="col-sm-3 center">
          ...
          <center>
            <img src="http://d2b8lqy494c4mo.cloudfront.net/mss/images/why/employees.png" class="img-responsive" alt="50K-Employees" title="50K Employees">
          </center>
          ...
          <div class="row">
            ...
            <div class="col-sm-12">
              ...
              <center>
                ...
                <p>
                  Grow Team Miracle to be 50,000 Employees by 2020
                </p>
              </center>
        ...
        <div class="col-sm-3 center">
          ...
          <center>
            <img src="http://d2b8lqy494c4mo.cloudfront.net/mss/images/why/systems-integrator.png" class="img-responsive" alt="Systems-Integrator" title="Systems Integrator">
          </center>
          ...
          <div class="row">
            ...
            <div class="col-sm-12">
              ...
              <h3 class="heavy">
                    No.1 Systems Integrator
                </h3>
                <p>
                  Providing best of breed Innovative Business Solutions
                </p>
              </center>
        ...
        <div class="col-sm-3 center">
          ...
          <center>
            <img src="http://d2b8lqy494c4mo.cloudfront.net/mss/images/why/diverse-ecosystem.png" class="img-responsive" alt="Diverse-Ecosystem" title="Diverse Ecosystem">
          </center>
          ...
          <div class="row">
            ...
            <div class="col-sm-12">
              ...
              <center>
                ...
                <p>
                  Build a sustainable talent pool by integrating into Academics
                </p>
              </center>
        ...
        <div class="col-sm-12">
          ...
          <div class="jumbotron">
            ...
            <p class="methodText">
              At Miracle Software Systems, Inc., our vision to be a highly respected, world class systems integrator, that provides top of the line innovative solutions, leveraging technology delivered by top notch people. We are working with our Ecosystem of Universities and Academic Organizations to be able to Produce the needed Workforce to be able to deliver the Best In Class People with the Latest Technological Skills necessary to help our customers be very successful in their Business Transformation and Optimization Initiatives.
            </p>
            <p class="methodText">
              We envision Miracle Software Systems, Inc. to be 50,000 Employees by 2020, making a huge difference in the lives of several people who live in our Home Towns across the Globe. For a Global Systems Integrator, it is the people , the Diverse Cultures, the Ideas and the Innovation that makes a huge Difference and we want to ensure that this ecosystem of People will be able to make our Vision happen.
            </p>
            <p class="methodText">
              Our results demonstrate that the investments that we have made into this ecosystem over the past 20 Years will make us get to our goals more precisely and quickly. Investing in Downstream Supply Chain of this Ecosystem by adopting the Academic Institutions for better quality people to be made instantly available for integration into the Miracle Team of Employees.
            </p>
            <p class="methodText">
              Miracle has a significant vision at producing the best and brightest variegated employees with varied perspectives and skills who work together to meet our consumer demands. It is very important for our teams to deliver the right services on time. Quality is of the essence while time always remains a necessity.
            </p>
            <p class="methodText">
              It is an integral and inherent part of our culture, fueling our business growth while allowing our Organization to attract, develop, and retain the best talent, to be more innovative in the products and services we develop, in the way we solve problems, and in the way we serve the needs of The Future Businesses rising global partner base.
            </p>
            <p class="methodText">
              Miracle is building a pipeline to be the world’s leading next generation technology solutions and services provider going beyond customer expectations by presenting them Business Values through Innovative Services. Our clients achieve superior returns on their technology investments through our best-in-class industry solutions, domain expertise of our people, and our global scale.
            </p>
            <p class="methodText">
              <strong>
                Miracle has a vision to be the best, and will be the Best to help our customers be at the top of their game. Join us as we take this mission forward, one step at a time.
              </strong>
            </p>
          </div>
        </div>
         ...
         <div class="col-sm-3 sidebar pull-right">
            ...
            <div class="mini-submenu">
               ...
               <div class="list-group">
                <a href="../about-us/" class="list-group-item-1">
                  <div>
                     <center><strong><font size="3%!important" color="#ffffff"  onMouseOut="this.style.color='#ffffff'" onMouseOver="this.style.color='#b7b2b3'">&nbsp; About Us
                        </font></strong>
                     </center>
                  </div>
               </a>
               
               <a href="partnerships.php" class="list-group-item">
                  <div>
                     <center><strong><font size="3%!important" color="#000000">&nbsp; Partnerships
                        </font></strong>
                     </center>
                  </div>
               </a>
               ...
               <a href="#" class="list-group-item">
                  <div>
                     <center>
                     <strong><font size="3%!important" color="#00aae7">&nbsp; Vision 2020
                     </font></strong>
                     </center>
                  </div>
               </a>
               
               <a href="awards.php" class="list-group-item">
                  <div>
                     <center>
                     <strong><font size="3%!important" color="#000">&nbsp; Awards & Certifications
                     </font></strong>
                     </center>
                  </div>
               </a>
               ...
               <br>
               <div >
                  <div class="widget-content themed-background text-light-op" style="background-color:#00aae7;height:62px;">
                     <center style="padding-top:5px;"><strong><font style="color:#ffffff;">Digital Experience </font></strong></center>
                  </div>
...
.container {
    padding: 2px 16px;
                        ...
                        <center>
                           <a href="#">
                              <h3 class="heavy"></h3>
                              <p><font size="3px"color="#fff"><style="opacity:0!important;"><strong>Web and Mobile Experience</strong></style></font></p>
                               <p><font size="3px"color="#fff"><style="opacity:0!important;"><strong>Social Experience and Insights</strong></style></font></p>
                           </a>
                        </center>
                     </div>
                  </div>
                  ...
                  <div class="widget-content  text-dark register-hover">
                     <a class="linkText1" href="http://www.miraclesoft.com/technologies/digital-experience-commerence" target="_blank">
                        <center  style="padding-top:1px;"><strong><font style="color:#ffffff;" onMouseOut="this.style.color='#fff'" onMouseOver="this.style.color='#b7b2b3'">Check now</font></strong></center>
                     </a>
                  </div>
              ...
              <span data-toggle="collapse">
                    <div class="widget">
                   <a href="mailto:info@miraclesoft.com"> <div class="widget-content widget-hover themed-background text-light-op">

...
.tinted-image {
  background: 
    ...
    /* your image */
    url("API-Management/images/code.png");
...
.animation-fadeInQuick2:hover{
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header hd-top">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h2 class="heavy micro">Hybrid Integration Architecture for Major Retail Customer</h2>
        </div>
        <div class="modal-body">
          <style>.embed-container { position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 100%; } .embed-container iframe, .embed-container object, .embed-container embed { position: absolute; top: 0; left: 0; width: 100%; height: 90%; }</style><div class='embed-container'> <iframe id='iframepdf' height='400' width='800'  src='EDGEi_WebPage_Content_v1.0.pdf'></iframe></div> </div>
        <div class="modal-footer ft-top">
         
              <div class="col-sm-6">
                  <h5 class=" noMarginTop heavy pull-left">&nbsp;&nbsp;&nbsp;Chanakya Lokam - January 5th, 2017</h5>
              </div>
              <div class="col-sm-6 noMarginTop">
                <button type="button" class="btn btn-success">Download</button>
          <button type="button" class="closepdf btn btn-danger" data-dismiss="modal">&nbsp;&nbsp;&nbsp;Close&nbsp;&nbsp;&nbsp;</button>
            ...
            <br><br><br>
                  ...
                  <option value="Mulesoft">Mulesoft</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 col-lg-3">
                                <div data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#myModal" class="media-items animation-fadeInQuick2" data-category="image">
                                    <div class="media-items-options text-right">
                                    ...
                                    <h4>
                                        <strong>API-Management</strong>.pdf<br>
                                        <small>EDGE Practice, 1.5MB</small>
                                    </h4>
                                </div>
                            </div>
                            <div class="col-sm-4 col-lg-3">

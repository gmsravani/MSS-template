...
<html lang="en">
    <head>
        ...
        <meta content="Our in-house grown methodologies have been proven and tested over time with numerous successful implementations" name="description">
        <meta content="" name="author">
        <title>
            Methodologies Like SCRUM, POWER and RING brings power to you. 
        </title>
...
<![endif]-->
 ...
 .tinted-image {
         ...
         /* your image */
         url("../why-miracle/images/methodlogies.png");
            ...
            <div class="container ">
               <div class="row">
                  ...
                  <div class="col-sm-6 text-left">
                     <h1 class="heavy micro">Methodologies</h1>
                  </div>
                  ...
                  <div class="col-sm-6 text-right">
                     <ul class="breadcrumb pull-right">
                        ...
                        <li>
                            <a href="../why-miracle">Why Miracle</a>
                        </li>
                        <li class="active">Methodologies
                        </li>
                     </ul>
                  </div>
               </div>
        ...
        <section class="container" id="career">
         ...
         <div class="col-sm-9">
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="jumbotron">
                      <h3 class="heavy">Paving the way to Success
                       </h3>
                        <p class="methodText">
                            Home grown Methodologies, Accelerators, Implementation Templates combined with Best Practices and Standards are at the core of Miracle's success. Our methodologies are industry and technology agnostic and have been proven through repeated use over the years. POWER is a methodology for Operations Support / Managed Services and RING is a methodology for Accelerated Development / Implementation of Integrations (A2A/B2B/EAI/Cloud & Mobile Integrations). Read more about our methodologies to see why we have been so successful for the last 20 years.
                        </p>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-6 center">
                    <center><img alt="power" title="Power" class="img-responsive" src="../why-miracle/images/whyIcons6.png"></center><br>
                    <div class="row">
                        
                        <div class="col-sm-12">
                             <h3 class="heavy">POWER
                            </h3>
                            <p>
                                Process Organized with Efficient Resources
                            </p><a href="../../why/power.php"><button class="btn btn-primary btn-md" type="button">Read More</button></a><br>
                        </div>
                    
                    </div>
                </div>
                <div class="col-sm-6 center">
                    <center><img alt="ring" title="Ring" class="img-responsive" src="../why-miracle/images/whyIcons7.png"></center><br>
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            ...
                            <p>
                                Rapid Integration Development Methodology
                            </p><a href="../../why/ring.php"><button class="btn btn-primary btn-md" type="button">Read More</button></a><br>
                        </div>
            ...
            <div class="list-group">
               ...
               <a href="../why-miracle/" class="list-group-item-1">
                  <div>
                     <center><strong><font size="3%!important" color="#ffffff"  onMouseOut="this.style.color='#ffffff'" onMouseOver="this.style.color='#b7b2b3'">&nbsp; Why Miracle
                        </font></strong>
                     </center>
                  </div>
               </a>
               <a href="global.php" class="list-group-item">
                  <div >
                     <center><strong><font size="3%!important" color="#000">&nbsp;Global Delivery Model
                        </font></strong>
                     </center>
                  </div>
               </a>
               <a href="#" class="list-group-item">
                  <div>
                     <center><strong><font size="3%!important" color="#00aae7">&nbsp; Our Methodologies
                        </font></strong>
                     </center>
                  </div>
               </a>
               
               <a href="coe-ecosystem.php" class="list-group-item">
                  <div>
                     <center>
                     <strong><font size="3%!important" color="#000">&nbsp; CoE Ecosystem
                     </font></strong>
                     <center>
                  </div>
               </a>
               
               <a href="innovation.php" class="list-group-item">
                  <div>
                     <center>
                     <strong><font size="3%!important" color="#000">&nbsp; Innovation Center
                     </font></strong>
                     <center>
                  </div>
               </a>
               ...
               <div >
                  <div class="widget-content themed-background text-light-op">
                     <center><strong><font color="#ffffff">Upcoming Events</font></strong></center>
                  </div>
...
.container {
    padding: 2px 16px;
                        ...
                        <center>
                           <a href="#">
                              <h3 class="heavy"></h3>
                              <p><font size="3px"color="#ffffff"><style="opacity:0!important;"><strong><font size="5px">MuleSoft Connect </font><br> April 18-20, 2017</strong></style></font></p>
                           </a>
                        </center>
                     </div>
                  </div>
                  <div class="widget-content  text-dark register-hover">
                     <a class="linkText1" href="https://connect.mulesoft.com/" target="_blank">

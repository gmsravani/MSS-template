               ...
               <div class="row">
                  ...
                  <div class="col-sm-6 text-right">
                     <ul class="breadcrumb pull-right">
                        <li><a href="../">Home</a></li>
                        <li><a href="/version-3.0/qa/index.php">Services</a></li>
                                ...
                                <div class="row">
                                    <div class="col-sm-4"><!--webinar--->
                                       ...
                                       <div class="embed-responsive embed-responsive-16by9">
                                           <a class="linkText1" target="_blank"  href="https://www.miraclesoft.com/events/webinar-after.php?eventId=147"><img src="images/testmanager.png" alt="testmanager" class="img-responsive"></a>
                                              ...
                                              <div class="card">
                                               <a class="linkText1" target="_blank"  href="http://www.miraclesoft.com/library/CaseStudy/testing-coe-global-carpet-manufacturer.php"><img  src="images/interface.png" alt="Testing COE" class="img-responsive">
                                                  <div class="container" style="background-color:#eee;">
                                                        ...
                                                        <p><center><strong>Establishing Testing COE for Global Carpet Manufacturer</strong></center><br></p> 
                                                  </div>
                                               </a>
                                           </div>
                                           </div>
                                ...
                                <div class="row">
                                      ...
                                      <div class="col-sm-4"><!--case study--->
                                        <div class="portfolio-item">
                                              ...
                                              <div class="effect ">
                                              <div class="card">
                                                  <a class="linkText1" target="_blank"  href="http://www.miraclesoft.com/library/CaseStudy/end-to-end-validation-qa-testing.php"><img  src="/version-3.0/qa/images/interface.png" alt="Global Financial Holdings" class="img-responsive">
                                               <div class="container" style="background-color:#eee;">
                                     ...
                                     <div class="col-sm-4"><!--webinar--->
                                        <div class="portfolio-item">
                                              ...
                                              <div class="effect ">
                                              <div class="card">
                                                  <a class="linkText1" target="_blank"  href="http://www.miraclesoft.com/webinars/testing-as-a-service-simple-on-demand-pay-as-you-go-model"><img  src="images/testingwebinar.png" alt="testingwebinar" class="img-responsive">
                                               <div class="container" style="background-color:#eee;">

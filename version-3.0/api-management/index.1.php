      ...
      <section id="services" class="container">
         ...
         <div class="col-sm-9">
           ...
           <div class="row">
             ...
             <h1 class="heavy">Miracle’s Offerings </h1>
             </div>
                      
               <div class="col-sm-3">
                    <div class="widget-content themed-background text-light-op" style="background-color:#0d416b;">
                    <strong><font color="#fff"> Service Discovery</font></strong>
                  </div>
                  <div class="widget box">
                     <div class="widget-content" style="padding:7px !important;background-color:#eee;border: 1px solid #eee; padding:3px;" >
                             <center> <br><p> Our teams can help you analyse your exisitng Service Architecture to see which Services can be exposed as APIs to unlock hidden business value</p>
                        </center></div>
                  </div>
               </div>
               <div class="col-sm-3">
                    <div class="widget-content themed-background text-light-op" style="background-color:#0d416b;">
                    <strong><font color="#fff"> Install and Configure</font></strong>
                  </div>
                  <div class="widget box">
                     <div class="widget-content" style="padding:7px !important;background-color:#eee;border: 1px solid #eee; padding:3px;" >
                        <br>
               ...
               <div class="col-sm-3">
                    <div class="widget-content themed-background text-light-op" style="background-color:#0d416b;">
                    <strong><font color="#fff">API M Integration</font></strong>
                  </div>
                  <div class="widget box">
                     <div class="widget-content" style="padding:7px !important;background-color:#eee;border: 1px solid #eee; padding:3px;" >
                              <center><br><p>With our experience with enterprise architectures we can help you connect all the dots with your API M strategy to ensure highest business value.</p>
                       </center> </div>
                  </div>
               </div>
               <div class="col-sm-3">
                    <div class="widget-content themed-background text-light-op" style="background-color:#0d416b;">
                    <strong><font color="#fff">Policy Development</font></strong>
                  </div>
                  <div class="widget box">
                     <div class="widget-content" style="padding:7px !important;background-color:#eee;border: 1px solid #eee; padding:3px;" >
                             <center> <br><p>Creating API proxies (or) building assemblies for transformation we can help with creation, deployment and maintenence of your Enterprise APIs</p>
                        </center></div>
                  </div>
               </div>
            ...
            <div class="row">
               <div class="col-sm-12">
                    ...
                    <div class="widget-content themed-background text-light-op" style="background-color:#0d416b;">
                    <strong><font color="#fff">Product Evaluation and Roadmap Planning</font></strong>
                  </div>
                  <div class="widget box">
                     <div class="widget-content" style="border: 1px solid #eee;background-color:#eee; padding:10px;" >
                            <p class="methodText">Through PoTs and Workshops we can help you evaluate and select the right platform for your API need, and can help plan your roadmap and API M strategy through discussions with product teams</p>
                        </div>
            ...
            <div class="row ">
               <div class="col-sm-6">
                ...
                <br> <a href="why-miracle.php"> <button type="button" class="btn btn-primary btn-sm">Read More</button></a>
               </div>
               <div class="col-sm-6">
                 <pre class="prettyprint linenums">
                  { 
   “<strong>API CoE</strong>” : 
	...
	“Innovation and Thought Leadership”;
            ...
            <div class="row">
               ...
               <div class="effect col-sm-4">
                  <div class="card">
  <img height="130px" src="images/healthcare.png" alt="Avatar" style="width:100%">
  <div class="container" style="background-color:#eee;">
    
    <p><a class="linkText" href="http://www.miraclesoft.com/why/sstory3.php"><center><strong>Migration from TPEC to WTX for Global Healthcare Leader</strong></center></a></p> 
  </div>
</div>
               </div> 
                <div class="effect col-sm-4">
                    <div class="card">
  <img height="130px" src="images/manufacturing.png" alt="Avatar" style="width:100%">
  <div class="container" style="background-color:#eee;">
     ...
     <p><a class="linkText" href="http://www.miraclesoft.com/why/sstory3.php"><center><strong>Migration from TPEC to WTX for Global Healthcare Leader</strong></center></a></p> 
                 ...
                 <div class="effect col-sm-4">
                     <div class="card">
  <img height="130px" src="images/energy.png" alt="Avatar" style="width:100%">
  <div class="container" style="background-color:#eee;">
     ...
     <p><a class="linkText" href="http://www.miraclesoft.com/why/sstory3.php"><center><strong>Migration from TPEC to WTX for Global Healthcare Leader</strong></center></a></p> 
            ...
            <div class="row">
                  ...
                  <div class="col-sm-3">
                    <div class="widget-content themed-background text-light-op" style="background-color:#b7b2b3 !important;">
                    <strong ><font color="#232527">IBM</font></strong>
                  </div>
                  <br>
                  <center><img src="images/ibm-4.png" alt="ibm logo" class="img-responsive"/></center>
                  <br>
                 <div class="widget-content themed-background text-light-op" style="background-color:#0d416b !important;">
                   <center><strong><font color="#fff">IBM	API	Connect</font></strong></center>
                  </div>
               </div>
               
              <div class="col-sm-3">
                    <div class="widget-content themed-background text-light-op" style="background-color:#b7b2b3 !important;">
                    <strong ><font color="#232527">Mulesoft</font></strong>
                  </div>
               <br>
                  <center><img style="background-color:#b7b2b3;" src="images/mulesoft.png" alt="mulesoft-partner logo" class="img-responsive"/></center>
<br>
                 <div class="widget-content themed-background text-light-op" style="background-color:#232527 !important;">
                  <center> <strong><font color="#fff">	Anypoint	Platform</font></strong></center>
                  </div>
               </div>
               
                 <div class="col-sm-3">
                    <div class="widget-content themed-background text-light-op" style="background-color:#b7b2b3 !important;">
                    <strong ><font color="#232527">CA</font></strong>
                  </div><br>
                  <center><img src="images/CA.png" alt="ca logo" class="img-responsive"/></center>

                 <div class="widget-content themed-background text-light-op" style="background-color:#d1dad9 !important;margin-top:16px;">
                  <center> <strong><font color="#0d416b">CA-Layer	7</font></strong></center>
                  </div>
               </div>
               <div  class="col-sm-3">
                    <div class="widget-content themed-background text-light-op" style="background-color:#b7b2b3 !important;">
                    <strong ><font color="#232527">Apigee</font></strong>
                  </div><br>
                  <center><img src="images/apigee-3.png" alt="apigee logo" class="img-responsive"/></center>
                 &nbsp;&nbsp;&nbsp;
                 <div class="widget-content themed-background text-light-op" style="background-color:#FF4500 !important;">
                   <center><strong><font color="#fff">Apigee	Edge</font></strong></center>
                  </div>
               </div>
         ...
         <div class="col-sm-3 sidebar pull-right">
            ...
            <div class="list-group">
               ...
               <a href="product-comparsion.php" class="list-group-item">
                  <div >
                     <center>
                     <strong><font size="3%!important" color="#000">&nbsp;Product Comparison
                     </font></strong>
                     <center>
                  </div>
               </a>
               ...
               <div >
                  <div class="widget-content themed-background text-light-op">
                     <center><strong><font color="#fff">Tech Article</font></strong></center>
                  </div>
                  <div class="widget box">
...
.container {
    padding: 2px 16px;
                           ...
                           #check {
                           background-image:url('images/bigdataimage.png'); 
                        ...
                        <center>
                           <a href="#">
                              <h3 class="heavy"></h3>
                              <p><font size="3px"color="#fff"><strong>Bringing the power of the API Economy to IBM Websphere Commerce</strong></font></p>
                           </a>
                        </center>
                     </div>
                  </div>
                  <div class="widget-content  text-dark register-hover">
                     <a class="linkText1" href="http://www.miraclesoft.com/library/TechnicalArticle/websphere-commerce-article.php" target="_blank">

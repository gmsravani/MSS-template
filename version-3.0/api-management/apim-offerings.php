      ...
      <section id="services" class="container">
         ...
         <div class="col-sm-9">
            <div class="row">
               <div class="col-sm-12">
                  <br>
                  <p class="methodText">From	 product	 evaluation	 to	 training,	 from	 implementation	 to	 innovation	 –	Miracle	 is	 your	 trusted	 partner	 for	 digital	 transformation	 through	 the	 API Economy.
                  </p>
               </div>
            </div>
           <div class="row">
             ...
             <h1 style="color:#0d416b" class="heavy noMarginTop">Miracle’s Offerings </h1>
               ...
               <div class="col-sm-3">
                    ...
                    <strong><font color="#fff"> <center>Service Discovery</center></font></strong>
                    </div>
               ...
               <div class="col-sm-3">
                    ...
                    <strong><font color="#fff"> <center>Install & Configure</center></font></strong>
                    </div>
                  <div class="widget box">
                     <div class="widget-content" style="padding:7px !important;background-color:#eee;border: 1px solid #eee; padding:3px;" >
               ...
               <div class="col-sm-3">
                    ...
                    <strong><font color="#fff"><center>API M Integration</center></font></strong>
                    </div>
                  <div class="widget box">
                     <div class="widget-content" style="padding:7px !important;background-color:#eee;border: 1px solid #eee; padding:3px;" >
                        <center><p>With our experience with enterprise architectures we can help you connect all the dots with your API M strategy to ensure highest business value.
                        </p>
                        </center>
                     </div>
                  </div>
               ...
               <div class="col-sm-3">
                    ...
                    <strong><font color="#fff"><center>Policy Development</center></font></strong>
                    </div>
                  <div class="widget box">
                     <div class="widget-content" style="padding:7px !important;background-color:#eee;border: 1px solid #eee; padding:3px;" >
           ...
           <div class="row">
            <div class="col-sm-6">
               ...
               <p>Over	 the	years	Miracle	has	proven	with	various	customers	 to	be	able	 to	 reduce the	 learning	 curve	 for	 enterprise	 technology	by	 conducting	 F2F	workshops	with professional	 instructors.	 The	 workshops	 include	 hands-on	 development	 which	
            ...
            <div class="row">
               <div class="col-sm-9">
                ...
                <img src="images/offering-enagegment-cycle.png"  alt="Offering Engagement Cycle" class="img-responsive"/>
               </div>
            </div>
         </div>
         <div class="col-sm-3 sidebar pull-right">
            ...
            <div class="list-group">
              ...
              <br>
               <div >
                   <div class="widget-content themed-background text-light-op">
                     <center><strong><font color="#fff">Webinar On-Demand</font></strong></center>
                  </div>
                  <div class="widget box">
                     <div class="widget-content" id="check" >
                        ...
                        <center>
                           <a href="#">
                              <h3 class="heavy"></h3>
                              <p><font size="3px"color="#fff"><strong>Building API M Center of Excellence and Best Practices </strong></font></p>
                           </a>
                        </center>
                     </div>
                  </div>
                  <div class="widget-content  text-dark register-hover">
                     <a class="linkText1" href="http://www.miraclesoft.com/events/webinar-after.php?eventId=176" target="_blank">
                        <center><strong><font color="#fff" onMouseOut="this.style.color='#fff'" onMouseOver="this.style.color='#b7b2b3'">Watch Replay</font></strong></center>
                     </a>
                  </div>
                  </a>
               </div>
              ...
              <div class="widget">
                   <a href="mailto:api@miraclesoft.com" >
         ...
         <div class="row">
            <div class="container">
                    <h2 class="heavy">Suggestions for You</h2>

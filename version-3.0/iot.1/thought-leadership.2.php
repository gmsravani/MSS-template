   ...
   <body>
      ...
      <section id="services" class="container">
         ...
         <div class="col-sm-9">
           ...
           <br>
           <div class="col-sm-4">
                <center class="widget-content themed-background text-light-op"><strong><font color="#ffffff">Learn with us</font></strong></center>
                <p class="methodText">Miracle has been a thought leader in the space of IoT over the last few years. Through our Digital Library you can explore a vast amount of resources and thought leadership pieces around the space of IoT.Miracle has been a thought leader in the space of IoT over the last few years. Through our Digital Library you can explore a vast amount of resources and thought leadership pieces around the space of IoT.
</p>
                       <button type="button" class="btn btn-primary">Click Me</button> 
           </div>
           
               <div class="col-sm-8 hover1" > 
            ...
            <br>
             ...
             <div class="col-sm-12">
                 <div class="col-sm-1"></div>
                  <div class="col-sm-2"><img src="images/solution.png" alt="solution" class="img-responsive" height="120" width="120" ></div>
                <div class="col-sm-2"><img src="images/team.png" alt="Expertise" class="img-responsive" height="120" width="120" ></div>
                <div class="col-sm-2"><img src="images/Platform4.png" alt="IoT Platform" class="img-responsive" height="120" width="120" ></div>                  
                <div class="col-sm-2"> <img src="images/guide.png" alt="Guidance" class="img-responsive" height="120" width="120" ></div>
                <div class="col-sm-2"> <img src="images/guide.png" alt="Guidance" class="img-responsive" height="120" width="120" ></div>
                <div class="col-sm-1"></div>
                 </div>
                 </div>
         ...
         <div class="row">
           ...
           style="background-image:url('images/laptop.png');background-repeat:no-repeat;width:100%;height:300px;">
               
               
    <div id="myCarousel" class="carousel slide" style="width:345px;height:255px;position:relative;left:63px;bottom:-20px;" class="col-sm-4 col-md-4 col-xs-12 col-lg-4" data-ride="carousel">
    <!-- Indicators -->
    ...
    <div class="carousel-inner">
      ...
      <div class="item active">
        <iframe width="345" height="255" src="https://www.youtube.com/embed/f890SC1schE" autoplay="1" frameborder="0" allowfullscreen>
                 </iframe>
      </div>

      <div class="item">
         <iframe width="345" height="255" src="https://www.youtube.com/embed/yQkvayPz3iw" autoplay="1" frameborder="0" allowfullscreen>
                 </iframe>
      </div>
    
      <div class="item">
        <iframe width="345" height="255" src="https://www.youtube.com/embed/A_TuAFsI8ak" autoplay="1" frameborder="0" allowfullscreen>
                 </iframe>
      </div>

                                ...
                                <div class="row">
                                    <div class="col-sm-4"><!--webinar--->
                                       ...
                                       <!--<a class="linkText1" target="_blank"  href="https://www.youtube.com/embed/9BiqIgEQxS8?list=PLvHEcCoZg9xzlcG8ZFU2ZFzcZI7DD53N1"><img src="images/exploring.png" alt="QA" class="img-responsive"></a>-->
                                        <a class="linkText1" target="_blank"  href="http://www.miraclesoft.com/library/video/dissecting-tank-o-meter-miracle-labs--interconnect-17.php"><img src="images/tank.png" alt="QA" class="img-responsive"></a>
                                      ...
                                      <div class="col-sm-4"><!--webinar--->
                                       ...
                                       <div class="embed-responsive embed-responsive-16by9">
                                          ...
                                          <a class="linkText1" target="_blank"  href="http://www.miraclesoft.com/library/video/interacting-thingchat-google-home-and-alexa.php"><img src="images/expanding.png" alt="QA" class="img-responsive"></a>  
                                    ...
                                    <a class="linkText1" target="_blank"  href="http://www.miraclesoft.com/events/webinar-after.php?eventId=73"><img src="images/simplify.png" alt="QA" class="img-responsive"></a>
                                                  ...
                                                  <div class="container" style="background-color:#eee; margin-top:-5px;">
                                                   <p class="methodText head"><center><strong>Simplifying the IoT Use Case with Bluemix, Devices and People</strong></center></p> 
                                                  </div>
                                               </a>
                                           </div>
                                           </div>
               ...
               <div >
                  ...
                  <div class="widget box">
                     <div class="widget-content" id="check" >
                        ...
                        <center>
                           <a href="http://www.miraclesoft.com/library/TechnicalArticle/iot-article.php">
                              <h3 class="heavy"></h3>
                  ...
                  <div class="widget-content  text-dark register-hover">
                     <a class="linkText1" href="http://www.miraclesoft.com/library/TechnicalArticle/iot-article.php" target="_blank">

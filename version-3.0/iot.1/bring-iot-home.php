      ...
      <section id="services" class="container">
         ...
         <div class="col-sm-9">
           ...
           <br>
               <div class="row">
                  <div class="col-sm-3">
                   <center>  <img src="images/6hours.png" alt="coding" class="img-responsive">
                      <br>  <h6 class="heavy">6 Hours of Coding</h6></center>
                </div>
               <div class="col-sm-3">
                   <center>  <img src="images/guided.png" alt="guided labs" class="img-responsive">
                      <br>     <h6 class="heavy">Guided Labs</h6></center>
               </div>
               <div class="col-sm-3">
                   <center>  <img src="images/digital.png" alt="digital" class="img-responsive">
                      <br>     <h6 class="heavy">Focus on Digital</h6></center>
               </div>
               <div class="col-sm-3">
                   <center>  <img src="images/innovation.png" alt="innovation" class="img-responsive">
               ...
               <div >
                  ...
                  <div class="widget box">
                     <div class="widget-content" id="check" >
                        ...
                        <center>
                           <a href="http://www.miraclesoft.com/webinars/building-connected-iot-mobile-apps-xamarin-azure-app-services">
                              <h3 class="heavy"></h3>

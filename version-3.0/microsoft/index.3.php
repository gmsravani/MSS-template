...
<!--style sheet-->
	...
	<link rel="stylesheet" href="../../NewFolder/css/bootstrap.css" type="text/css" />
	<link rel="stylesheet" href="../../NewFolder/style.css" type="text/css" />
<link rel="stylesheet"     href="../../NewFolder/css/swiper.css" type="text/css" />
	<link rel="stylesheet" href="../../NewFolder/css/dark.css" type="text/css" />
	<link rel="stylesheet" href="../../NewFolder/css/font-icons.css" type="text/css" />
	<link rel="stylesheet" href="../../NewFolder/css/animate.css" type="text/css" />
	<link rel="stylesheet" href="../../NewFolder/css/magnific-popup.css" type="text/css" />

	<link rel="stylesheet" href="../../NewFolder/css/responsive.css" type="text/css" />
 ...
 <section id="services" >
        ...
        <div class="container ">
          ...
          <div class="col-sm-9 text-left">  
            <h1 class="heavy "> <font color="#ffffff">Microsoft Technology</font></h1>
          ...
          <div class="col-sm-3 text-right">
            ...
            <ul class="breadcrumb pull-right">
                ...
                <li><a href="../technologies/"><font color="#ffffff">Technologies</font></a></li>
                <li class="active"><font color="#ffffff">Microsoft Technology</font></li>
            </ul>
...
.container {
    padding: 2px 16px;
         ...
         rgba(0, 0, 0, 0.55), 
         rgba(0, 0, 0, 0.55)),
         url("../QA-Services/images/bhelk.png"); 
         ...
         .widget-icon .gi,.widget-icon .hi,.widget-icon .si,.widget-icon .fi {margin-top: -3px;}
              ...
              <span data-toggle="collapse" id="menu-button">
                    <div class="widget">
                   <a href="mailto:microsoft@miraclesoft" > 
...
$('body,html').click(function(e){
  ...
  <!--/#about-us-->
	...
	<script type="text/javascript" src="../../NewFolder/js/plugins.js"></script>
		<script type="text/javascript" src="../../NewFolder/js/functions.js"></script>

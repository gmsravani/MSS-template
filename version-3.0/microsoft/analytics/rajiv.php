...
.rh-cta-link[data-rh-cta-type='primary'], .rh-customer-success-cta, .rh-featured-item-cta, .rh-pagination-btn-prev[data-rh-state='active'], .rh-pagination-btn-next[data-rh-state='active'] {
...
<div class="container">
<div class="row">
    <div class="col-sm-4" style="padding:40px;border:1px solid black;">
         <div class="new" style="background-color:white;padding:30px;
        border:solid 1px red;height:auto;">
            
            <div class="logo">
                <img class="img-responsive" src="cox.png">
            </div>
            <div class="main-image" style="margin-bottom:1.6em">
                <img class="img-responsive" src="cox1.jpg" style="width:100%;height: auto;display: block;">
            </div>
            <div class="success-content">
                <h2 class="success-title">Cox Automotive improves experience for car buyers and sellers</h2>
                <p class="success-summary">
            Cox Automotive needed a system that would help it continuously develop new products and deliver them faster to customers.
                </p>            
            </div>
            <div class="read-more">
                <a class="rh-customer-success-cta" href="https://www.redhat.com/en/success-stories/cox-automotive">Read more</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-sm-4" style="padding:40px;border:1px solid black;">
        ...
        <div class="new" style="background-image:url(jboss.1.png);
        background-repeat:none;background-color:white;padding:30px;
        border:solid 1px red;height:370px;">
            
            <div class="header">
                <h3 class="title" style="color:#252527 !important">
                    JBoss Middleware
                </h3>
            </div>
            <div class="title-body">
                <ul class="title-list" style="padding-left:20px;">
                    <li>
                        <a href="/en/success-stories/genfare" class="ux-list-products-item">Genfare</a>
                    </li>
                    <li>
                        <a href="/en/success-stories/sprint" class="ux-list-products-item">Sprint</a>
                    </li>
                    <li>
                        <a href="/en/success-stories/avianca" class="ux-list-products-item">Avianca</a>
                    </li>
                    <li>
                        <a href="/en/success-stories/tmg" class="ux-list-products-item">Telegraph Media Group</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="col-sm-4" style="padding:40px;border:1px solid black;">
        ...
        <div class="new" style="background-color:white;border:solid 1px red;height:370px;">
            <div class="img3">
                <img class="img-responsive" src="center.jpg" style="width:100%;height:150px;display:block;">
            </div>
            <div class="content3" style="margin:0 30px 0 30px;padding:30px 0 30px 0;background-color:white;height:200px">
                <div class="one">
                   <img class="img-responsive" src="cerner.png">
                </div>
                <div class="two" style="padding-top:15px;">
                    <p>Cerner boosts performance and stability</p>
                </div>
                <div class="three">
                    <a class="links" href="#">Read the story</a>
                </div>
            </div>
        </div>

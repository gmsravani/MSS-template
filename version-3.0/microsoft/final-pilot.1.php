   ...
   <body>
      ...
      <section id="services" class="container">
         ...
         <div class="col-sm-9">
            ...
            <div class="row">
               <div class="col-sm-4">
                  <img src="images/microsoft_logo.png" class="img-responsive"/>
               </div>
               <div class="col-sm-8">
                  <br>
            ...
            <div classs="row">
               <img src="images/microsoft_services.png" class="img-responsive">
            </div>
            <div class="row">
             <div class="col-sm-12">
                <h1 class="heavy">
         ...
         <div class="row">
            ...
            <p class="methodText">
               For more information regarding Miracle’s Microsoft Services portfolio please reach out to <strong><a href="mailto:miraclesoft.com" class="linkText">microsoft@miraclesoft.com</a></strong>
            </p></div>

            ...
            <div class="container ">
               <div class="row">
                  ...
                  <div class="col-sm-6 text-left">
                     <h1 class="heavy micro">Big Data<br></h1>
                  </div>
      ...
      <section id="services" class="container">
         ...
         <div class="col-sm-9">
            <div class="row">
               <div class="col-sm-12">
                  <br>
                  <p class="methodText">Big Data represents a new era in data exploration and utilization. It is an evolving term, which describes the volumetric amount of structured and unstructured data. Big Data helps enterprise to analyze user behavior and patterns, and in turn evolve their business model to suit their customers and hence drive their business further.  </p>
<p class="methodText">Dealing with larger data sets provides a strategic advantage for organizations, yet it also provides us with a unique hurdle for creating, manipulating and managing such large heterogeneous data sets. When properly harnessed, these huge sets of data can positively affect your enterprise through Business Analytics.   </p>
               </div>
            </div>
           <div class="row">
              <div class="col-sm-12">
                 <p class="methodText">Big Data needs something much more advanced than the regular Business Analytics suites available, as data becomes more heterogeneous, diversified and complex day-by-day. Our teams have been innovating with tools such as Tableau Software, IBM Cognos Enterprise, Hadoop and others to give you the edge when it comes to data. Make better decisions through real-time data analytics and in turn provide rapid growth for your organization.  </p>
              <div class="row">
                   <div class="col-sm-6">
            ...
            <p class="methodText">
             For more information on <strong>Big Data and Analytics Services</strong>, contact us at <a class="linkText" href="mailto:bigdata@miraclesoft.com"><strong style="text-decoration: underline">bigdata@miraclesoft.com</strong></a>
            </p>
         ...
         <div class="col-sm-3 sidebar pull-right">
            ...
            <div class="list-group">
               ...
               <a href="#" class="list-group-item">
                  <div >
                     <center><strong><font size="3%!important" color="#00aae7">&nbsp;Big Data
...
.container {
    padding: 2px 16px;
         ...
         url("images/bmc.png");
                        ...
                        <center>
                           <a href="http://www.miraclesoft.com/events/webinar-after.php?eventId=213">
                              <h3 class="heavy"></h3>
                              <p><font size="3px" color="#fff"><strong>Sentiment Analytics on Social Data using Dash DB and Watson Analytics </strong></font></p>
                           </a>
                        </center>
                     </div>
                  </div>
                  <div class="widget-content  text-dark register-hover">
                     <a class="linkText1" href="http://www.miraclesoft.com/events/webinar-after.php?eventId=213" target="_blank">

        ...
        <section class="container" id="about-us">
            <div class="row">
               <div class="col-sm-9">
                   ...
                   <p class="methodText">A true digital enterprise will integrate information, processes, work and people so that the entire organization can collaborate more efficiently and effectively, and therefore produce more valuable products and services. In order to make better and faster
                    decisions and to improve productivity, today’s most progressive businesses are leveraging SAP technologies to put highly contextualized information in the hands of their employees, partners, and clients.</p>
                  
                      <div class="row">
           <div class="col-sm-12"><br>
          <img src="/version-3.0/sap/images/SAP-journey.png" class="img-responsive"></img>
           </div>
          <br>
          <div class="col-sm-12">
          <p class="methodText" style="font-size:20px!important;color:#000;">
             <strong> Miracle Software Systems, Inc. is a national implementation and EDGE development</strong>
          </p>
            </div>     
            </div>
                 &nbsp;<br>
	...
	<p><center><strong>Explore the world of SAP USER Experience(UX) with SAP Fiori</strong></center></p>
            ...
            <div class="list-group">
              <a href="#" class="list-group-item-1">
               ...
               <a href="sap-services-offerings.4.php" class="list-group-item">
                  <div>

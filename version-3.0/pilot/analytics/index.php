...
<div class="row">
    <div class="col-sm-9">
	    ...
	    <div class="col-sm-3"> 
	        <center><img src="../images/3.png" class="img-responsive" alt=""></center>
	         
	    </div>
	    <div class="col-sm-3">
	        <center><img src="../images/4.png" class="img-responsive" alt=""></center>
	       
	    </div>
	    <div class="col-sm-3">
	        <center><img src="../images/2.png" class="img-responsive" alt=""></center>
	        
	    </div>
	    <div class="col-sm-3">
	        <center><img src="../images/artboard1.png" class="img-responsive" alt=""></center>
       ...
       <div class="row">
        ...
        <img src="../images/analytics-mircrosoftBI.png" alt="microst infrastructure" class="img-responsive">
   ...
   <div class="col-sm-6">
       <p class="methodText">
          <ul><li><strong>Data Quality, Governance, & Master Data Management</strong>
                <ul>
    ...
    <div class="row">
        ...
        <p class="methodText">For more information regarding our <strong>Microsoft Business Intelligence and Analytics Services,</strong> reach out to us at <a href="mailto:mircosoft@miraclesoft.com" class="linkText"><strong>mircosoft@miraclesoft.com.</strong></a></p>

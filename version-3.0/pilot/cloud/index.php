...
<div class="row">
    <div class="col-sm-9"><br>
      <p class="methodText">The Enterprise Cloud is no more a cost reducer, today it is a business differentiator that enables innovation and growth. <strong>Microsoft’s cloud solution, Azure</strong> is enabling organizations of all sizes to get to the cloud quicker with maximum affordability and flexibility. The Azure platform is used to deliver superior performance while helping to control costs. Microsoft Azure can extend your infrastructure and provides scalable, durable cloud storage, backup and recovery solutions for any data, big and small.</p>
				...
				<img class="img-responsive" src="../images/microsoft-azure.png">
				<br>
	...
	<div class="row">
		    <div class="col-sm-12">
		    <p class="methodText">
		        For more information regarding our <strong>Microsoft Cloud, IoT and DevOps Offerings</strong>, reach out to us at <a href="mailto:microsoft@miraclsoft.com" class="linkText"><strong> mircosoft@miraclesoft.com. </strong></a>
		    </p>
		</div>
		</div>
